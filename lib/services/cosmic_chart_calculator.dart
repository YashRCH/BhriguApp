  ...
  CosmicChartResult calculate({
    ...
    for (int i = 0; i < planetKeys.length; i++) {
      for (int j = i + 1; j < planetKeys.length; j++) {
        ...
        } else if ((shortestDist - 90).abs() <= 8) {
          aspects.add('$p1 Square $p2');
        } else if ((shortestDist - 120).abs() <= 8) {
          aspects.add('$p1 Trine $p2');
        } else if ((shortestDist - 180).abs() <= 8) {
          aspects.add('$p1 Opposition $p2');
        } else if (shortestDist <= 8) {
          aspects.add('$p1 Conjunction $p2');
        }
      }
    }
